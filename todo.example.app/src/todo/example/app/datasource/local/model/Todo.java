package todo.example.app.datasource.local.model;
...
public class Todo {
	...
	public Todo(int id, String title, String details, LocalDate dueDate) {
		this.id.set(id);
	...
	public Todo copy() {
		return new Todo(getId(), getTitle(), getDetails(), getDueDate());
	}
